...
class DownloadThread(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            metadata_for_image = {'image_link': actual_image_link}
...
class WordImageDownloader:
    def __init__(self, scraper, word, word_index, href_attributes, verbose_mode):
        ...
        # lock to ensure thread safe updating of the metadata hash or all the images for this word
    ...
    def process_word(self):
        ...
        for link_index, href_attribute in enumerate(self.href_attributes):
            #TODO: current_metadata = self.metadatas[link_index]
            user_agent = self.scraper.get_random_user_agent()
            current_thread = DownloadThread(self, href_attribute, link_index,
...
class GoogleImageScraper(object):
    ...
    def get_href_attributes_for_word(self, word):
        ...
        for attempt in range(10):          
            try:
                ...
                print(self.driver.find_elements_by_xpath(GOOGLE_METADATA_XPATH))
                for element in self.driver.find_elements_by_xpath(GOOGLE_METADATA_XPATH):
    ...
    def process_all_words(self):
        ...
        for word_index, foreign_word in enumerate(self.foreign_word_list):
            ...
            word_image_downloader = WordImageDownloader(self, foreign_word, word_index, href_attributes,
                                                        self.verbose_mode)
